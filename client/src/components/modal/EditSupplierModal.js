    ...
    <div className="add-supplier-modal">
      <div className="card" style={{ width: '18rem' }}>
        <div className="card-body">
          <h5 className="text-center mb-4">EditSupplier Form</h5>
          <form>
            <div className="mb-3">
            ...
            <div className="text-center">
              <button onClick={() => props.setIsShowEditSupplierModal(false)} type="button" className="btn btn-danger mx-1">Cancel</button>
