    ...
    <div className="edit-product-modal">
      <div className="card" style={{ width: '18rem' }}>
        <div className="card-body">
          <h5 className="text-center mb-4">Edit Product Form</h5>
          <form>
            <div className="mb-3">
            ...
            <div className="text-center">
              <button onClick={() => props.setIsShowEditProductModal(false)} type="button" className="btn btn-danger mx-1">Cancel</button>
